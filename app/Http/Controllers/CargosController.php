...
class CargosController extends Controller
{
        ...
        public function __construct()
        {
            ...
            $this->modulo_url = 'cargos';
            $this->modulo_nombre = 'Cargo';
        }
        ...
        public function listado()
        {
            ...
            return Datatables::of(
                DB::table('cargos')->orderBy("id","desc")->get()
                ...
                return '
                    ...
                    <a href="'.env('APP_URL').'cargos/'.$datos->id.'/edit" class="btn bg-cyan btn-xs waves-effect"><i class="material-icons">mode_edit</i></a>
        ...
        public function show($id)
        {
            ...
            return response()->json(['success'=>$cargos]);
        ...
        {  
            ...
            return view($this->modulo_url.'.edit',compact('cargos','modulo_url','modulo_nombre'));
        ...
        public function update(Request $request,$id)
        {
            ...
            Cargos::find($id)->update($request->all());
