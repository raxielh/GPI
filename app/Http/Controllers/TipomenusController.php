...
use Validator;
use App\Models\Tipomenus;

class TipomenusController extends Controller
{
        ...
        public function __construct()
        {
            ...
            $this->modulo_url = 'tipomenus';
            $this->modulo_nombre = 'Tipo menu';
        }
        ...
        public function listado()
        {
            ...
            return Datatables::of(
                DB::table('tipomenus')->orderBy("id","desc")->get()
                ...
                return '
                    ...
                    <a href="'.env('APP_URL').'tipomenus/'.$datos->id.'/edit" class="btn bg-cyan btn-xs waves-effect"><i class="material-icons">mode_edit</i></a>
        ...
        public function show($id)
        {
            ...
            $tipomenus=DB::table('tipomenus')
            ->where('id',$id)
            ->get();
    
            return response()->json(['success'=>$tipomenus]);
        ...
        {  
            ...
            $tipomenus=Tipomenus::find($id);
            return view($this->modulo_url.'.edit',compact('tipomenus','modulo_url','modulo_nombre'));
        ...
        public function update(Request $request,$id)
        {
            ...
            Tipomenus::find($id)->update($request->all());
        ...
        {
            $Tipomenus = Tipomenus::findOrFail($id);
            $Tipomenus->delete();
