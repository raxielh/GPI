...
class CausasController extends Controller
{
        ...
        public function __construct()
        {
            ...
            $this->modulo_url = 'causas';
            $this->modulo_nombre = 'Causa';
        }
        ...
        public function listado()
        {
            ...
            return Datatables::of(
                DB::table('causas')->orderBy("id","desc")->get()
                ...
                return '
                    ...
                    <a href="'.env('APP_URL').'causas/'.$datos->id.'/edit" class="btn bg-cyan btn-xs waves-effect"><i class="material-icons">mode_edit</i></a>
        ...
        public function show($id)
        {
            ...
            return response()->json(['success'=>$causas]);
        ...
        {  
            ...
            $causas=Causas::find($id);
            return view($this->modulo_url.'.edit',compact('causas','modulo_url','modulo_nombre'));
        ...
        public function update(Request $request,$id)
        {
            ...
            Causas::find($id)->update($request->all());
